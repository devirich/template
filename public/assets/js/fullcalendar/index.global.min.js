...
var FullCalendar = (function (e) {
  ...
  class Ln extends Un {
    ...
    render() {
      ...
      if (null != r) {
        ...
        if (!0 === e) c = !0;
        else if (n.handleCustomRendering) l = e;
        else {
  ...
  class Qn extends v {
    constructor() {
      super(...arguments), (this.InnerContent = qn.bind(void 0, this));
    }
    render() {
      const { props: e } = this,
        t = (function (e, t) {
  ...
  function Xn(e, t) {
    let n,
      ...
      i = [],
      { start: s } = t;
    for (e.sort($n), n = 0; n < e.length; n += 1)
      (r = e[n]),
  ...
  class lr {
    ...
    build(e, t, n = !0) {
      ...
      return (
        ...
        (a = o),
        c.showNonCurrentDates || (a = Jn(a, i.range)),
  ...
  function dr(e, t, n) {
    ...
    for (let e in o) {
      ...
      if (n.recurringDef) {
        ...
        let l = ur(n, o, t, r, i.recurringTypes);
        for (let t of l) {
          let n = cr(e, { start: t, end: r.add(t, o) });
          a[n.instanceId] = n;
        }
      }
    }
  ...
  const hr = {
    ...
    fr = { start: fn, end: fn, date: fn, allDay: Boolean },
    gr = Object.assign(Object.assign(Object.assign({}, hr), fr), {
      extendedProps: fn,
    });
  function pr(e, t, n, r, i = vr(n), s, o) {
    let { refined: a, extra: l } = mr(e, n, i),
      c = (function (e, t) {
        let n = null;
        e && (n = e.defaultAllDay);
    ...
    if (u) {
      let e = yr(a, l, t ? t.sourceId : "", u.allDay, u.hasEnd, n, s),
        r = cr(e.defId, u.range, u.forcedStartTzo, u.forcedEndTzo);
      return (
  ...
  function mr(e, t, n = vr(t)) {
    return hn(e, n);
  }
  function vr(e) {
    return Object.assign(
      Object.assign(Object.assign({}, Rr), gr),
  ...
  function br(e, t, n, r, i, s) {
    let o = { defs: {}, instances: {} },
      a = vr(n);
    for (let l of e) {
      let e = pr(l, t, n, r, a, i, s);
      e && Er(e, o);
    }
    return o;
  }
  function Er(e, t = { defs: {}, instances: {} }) {
    return (
  ...
  function Or(e) {
    return Object.assign(
      Object.assign(Object.assign({}, Rr), Mr),
    ...
    switch (t.type) {
      case "RECEIVE_EVENTS":
        return (function (e, t, n, r, i, s) {
          if (t && n === t.latestFetchId) {
            let n = br(Pr(i, t, s), t, s);
            return r && (n = dr(n, r, s)), Dr(Br(e, t.sourceId), n);
          }
          return e;
      ...
      case "RESET_RAW_EVENTS":
        return (function (e, t, n, r) {
          ...
          let o = br(Pr(n, t, r), t, r, !1, i, s);
          t.fetchRange && (o = dr(o, t.fetchRange, r));
          return o;
  ...
  function Pr(e, t, n) {
    ...
    return i && (e = Hr(e, i)), r && (e = Hr(e, r)), e;
  }
  function Hr(e, t) {
    let n;
    if (t) {
      ...
      (function (e) {
        ...
        t =
          !0 === e
            ...
            ? [e]
            : [];
        return (t = t.map((e) => Object.assign(Object.assign({}, zr), e))), t;
      })(e),
      null,
      t
    );
  ...
  function Wr(e, t, n) {
    n.emitter.trigger(
      "select",
      Object.assign(Object.assign({}, Lr(e, n)), {
  ...
  function Lr(e, t) {
    ...
    return (
      Object.assign(
        ...
        ((r = e),
        (i = t.dateEnv),
        Object.assign(Object.assign({}, vi(r.range, i, r.allDay)), {
          allDay: r.allDay,
        }))
      ),
      n
  ...
  class Yr {
    ...
    setProp(e, t) {
      if (e in fr)
        ...
        (t = hr[e](t)), this.mutate({ standardProps: { publicId: t } });
      else if (e in hr)
        (t = hr[e](t)), this.mutate({ standardProps: { [e]: t } });
      else if (e in Rr) {
        let n = Rr[e](t);
        (n =
          "color" === e
    ...
    setDates(e, t, n = {}) {
      ...
      if (o && (null == t || ((r = i.createMarker(t)), r)) && this._instance) {
        ...
        !0 === n.allDay && (e = rr(e));
        let t = or(e.start, o, i, n.granularity);
        if (r) {
          let o = or(e.end, r, i, n.granularity);
          (l = o),
            (a = t).years === l.years &&
            a.months === l.months &&
            a.days === l.days &&
  ...
  function Xr(e, t, n) {
    ...
    for (let e in i) {
      let n = i[e],
        a = r[n.defId];
      n.instanceId !== o && s.push(new Yr(t, a, n));
    }
    return s;
  }
  function $r(e, t, n, r) {
  ...
  const fi = { start: fn, end: fn, allDay: Boolean };
  function gi(e, t, n) {
    let r = (function (e, t) {
        let { refined: n, extra: r } = hn(e, fi),
  ...
  function mi(e, t, n) {
    return Object.assign(Object.assign({}, vi(e, t, n)), {
      timeZone: t.timeZone,
    });
  }
  function vi(e, t, n) {
  ...
  class Di extends Un {
    ...
    render() {
      ...
      return Ai() || s.push("fc-liquid-hack"), e.children(s, i, r, n);
    }
    componentDidMount() {
  ...
  class xi {
    ...
    addEvent(e, t) {
      if (e instanceof Yr) {
        ...
        return (
          this.getCurrentData().eventStore.defs[t.defId] ||
            (this.dispatch({
              type: "ADD_EVENTS",
              eventStore: Er({ def: t, instance: n }),
            }),
      ...
      let i = pr(e, n, r, !1);
      if (i) {
        let e = new Yr(r, i.def, i.def.recurringDef ? null : i.instance);
        return (
          this.dispatch({ type: "ADD_EVENTS", eventStore: Er(i) }),
          this.triggerEventAdd(e),
          e
        );
      }
    ...
    getEventById(e) {
      ...
      for (let i in n) {
        let s = n[i];
        if (s.publicId === e) {
          if (s.recurringDef) return new Yr(t, s, null);
          for (let e in r) {
            let n = r[e];
            if (n.defId === s.defId) return new Yr(t, s, n);
          }
        }
      }
      return null;
    ...
    getEventSources() {
      let e = this.getCurrentData(),
        t = e.eventSources,
        n = [];
      for (let r in t) n.push(new qr(e, t[r]));
      return n;
    }
    getEventSourceById(e) {
      let t = this.getCurrentData(),
        n = t.eventSources;
      e = String(e);
      for (let r in n) if (n[r].publicId === e) return new qr(t, n[r]);
      return null;
    }
    addEventSource(e) {
      let t = this.getCurrentData();
  ...
  class Ni {
    ...
    splitProps(e) {
      let t = this.getKeyInfo(e),
        ...
        l = {};
      this.eventUiBuilders = vn(t, (e, t) => this.eventUiBuilders[t] || Ut(Pi));
      for (let n in t) {
        let c = t[n],
          d = s[n] || Oi,
      ...
      if (e) {
        let n = this._splitEventStore(
          ...
          s = (r) => {
            t[r] ||
              (t[r] = {
                affectedEvents: n[r] || Oi,
                mutatedEvents: i[r] || Oi,
                isEvent: e.isEvent,
              });
          };
        for (let e in n) s(e);
  ...
  const ji = tn({ year: "numeric", month: "long", day: "numeric" }),
    zi = tn({ week: "long" });
  function Ui(e, t, n = "day", r = !0) {
    const { dateEnv: i, options: s, calendarApi: o } = e;
    let a = i.format(t, "week" === n ? zi : ji);
    if (s.navLinks) {
      let e = i.toDate(t);
      const l = (e) => {
        let r =
  ...
  function qi(e, t = !1, n) {
    let r = n ? e.getBoundingClientRect() : Yi(e),
      i = Qi(e, t),
      s = {
  ...
  class Xi {
    ...
    similarTo(e) {
      return (
        $i(this.tops || [], e.tops || []) &&
        $i(this.bottoms || [], e.bottoms || []) &&
        $i(this.lefts || [], e.lefts || []) &&
        $i(this.rights || [], e.rights || [])
      );
    }
  }
  function $i(e, t) {
  ...
  class ns {
    ...
    splitEntry(e, t, n) {
      ...
      return (
        ...
        r
          ? (n.push(
              { index: e.index, thickness: e.thickness, span: os(o, s) },
              ...i
            ),
            r)
          : (n.push(e), 0)
    ...
    insertEntryAt(e, t) {
      ...
      -1 === t.lateral
        ? (as(r, t.level, t.levelCoord), as(n, t.level, [e]))
        : as(n[t.level], t.lateral, e),
        (this.stackCnts[is(e)] = t.stackCnt);
    }
    findInsertion(e) {
      let {
          levelCoords: t,
      ...
      for (let u = 0; u < s; u += 1) {
        ...
        let h,
          f = n[u],
          g = ls(f, e.span.start, rs),
          p = g[0] + g[1];
        for (; (h = f[p]) && h.span.start < e.span.end; ) {
          let e = s + h.thickness;
          e > o && ((o = e), (c = h), (a = u), (l = p)),
            e === o && (d = Math.max(d, i[is(h)] + 1)),
            (p += 1);
        }
      }
      let u = 0;
      ...
      let h = -1;
      return (
        u < s && t[u] === o && (h = ls(n[u], e.span.end, rs)[0]),
        {
          touchingLevel: a,
          touchingLateral: l,
          touchingEntry: c,
  ...
  const ds = {},
    us = { startTime: lt, duration: lt, create: Boolean, sourceId: String };
  function hs(e) {
    let { refined: t, extra: n } = hn(e, us);
    return {
  ...
  class ms extends Un {
    render() {
      let { dateEnv: e, options: t, theme: n, viewApi: r } = this.context,
        ...
        d = !a.isDisabled && i.colCnt > 1 ? Ui(this.context, s) : {},
        u = Object.assign(
          Object.assign(
  ...
  class ys extends Un {
    render() {
      ...
      return f(
        ...
        {
          elTag: "th",
          elClasses: [gs, ...Bi(o, n), ...(e.extraClassNames || [])],
          elAttrs: Object.assign(
        ...
        (n) =>
          f(
            ...
            f(n, {
              ...
              elAttrs: { "aria-label": t.format(s, vs) },
            })
          )
      );
    }
  ...
  class bs extends v {
    ...
    computeTiming() {
      ...
      return (
        (s = Math.min(864e5, s)),
        {
          currentState: { nowDate: r, todayRange: Es(r) },
          nextState: { nowDate: i, todayRange: Es(i) },
          waitMs: s,
        }
      );
    }
  ...
  class Ss extends Un {
    constructor() {
      super(...arguments), (this.createDayHeaderFormatter = Ut(As));
    }
    render() {
      let { context: e } = this,
        {
  ...
  class Cs {
    ...
    _sliceBusinessHours(e, t, n, r, ...i) {
      return e
        ? this._sliceEventStore(dr(e, Rs(t, Boolean(n)), r), {}, t, n, ...i).bg
        : [];
    }
    _sliceEventStore(e, t, n, r, ...i) {
      if (e) {
        let s = $r(e, t, Rs(n, Boolean(r)), r);
        return {
    ...
    _sliceInteraction(e, t, n, r, ...i) {
      if (!e) return null;
      let s = $r(e.mutatedEvents, t, Rs(n, Boolean(r)), r);
      return {
    ...
    _sliceDateSpan(e, t, n, r, i, ...s) {
      ...
      if (a) {
        let t = (function (e, t, n) {
            let r = mr({ editable: !1 }, n),
              i = yr(r.refined, r.extra, "", e.allDay, !0, n);
            return {
              def: i,
              ui: ni(i, t),
              instance: cr(i.defId, e.range),
              range: e.range,
              isStart: !0,
              isEnd: !0,
            };
  ...
  function xs(e, t, n) {
    ...
    for (let e in r) if (!tr(t.validRange, r[e].range)) return !1;
    return Ts({ eventDrag: e }, n);
  }
  function _s(e, t, n) {
    return !!tr(t.validRange, e.range) && Ts({ dateSelection: e }, n);
  }
  function Ts(e, t) {
    ...
    return (t.pluginHooks.isPropsValid || ks)(r, t);
  }
  function ks(e, t, n = {}, r) {
    return (
      !(
        ...
        !(function (e, t, n, r) {
          let i = t.getCurrentData(),
            ...
            a = o.defs,
            l = o.instances,
            c = ti(a, s.isEvent ? e.eventUiBases : { "": i.selectionConfig });
          r && (c = vn(c, r));
          let d =
              ((g = e.eventStore),
          ...
          for (let r in l) {
            let o = l[r],
              ...
              p = c[o.defId],
              m = a[o.defId];
            if (!Ms(p.constraints, g, d, e.businessHours, t)) return !1;
            ...
            for (let e in h) {
              ...
              if (er(g, n.range)) {
                ...
                if (y && !y(new Yr(t, u[n.defId], n), new Yr(t, m, o)))
                  return !1;
              }
            }
            let b = i.eventStore;
            for (let e of p.allows) {
              let i,
                ...
                a = b.defs[m.defId],
                l = b.instances[r];
              if (((i = a ? new Yr(t, a, l) : new Yr(t, m)), !e(Lr(s, t), i)))
                return !1;
            }
          }
          return !0;
      ...
      !(
        ...
        !(function (e, t, n, r) {
          ...
          r && (c = r(c));
          if (!Ms(c.constraints, l, i, e.businessHours, t)) return !1;
          ...
          for (let e in o) {
            ...
            if (er(l, n.range)) {
              ...
              if (u && !u(new Yr(t, s[n.defId], n), null)) return !1;
            }
          }
          for (let e of c.allows) {
            let r = Object.assign(Object.assign({}, n), a);
            if (!e(Lr(r, t), null)) return !1;
          }
          return !0;
        })(e, t, n, r)
      )
  ...
  function Ms(e, t, n, r, i) {
    for (let s of e) if (!Ns(Is(s, t, n, r, i), t)) return !1;
    return !0;
  }
  ...
  function Ns(e, t) {
    for (let n of e) if (tr(n, t)) return !0;
    return !1;
  }
  const Ps = /^(visible|hidden)$/;
  class Hs extends Un {
    constructor() {
      super(...arguments),
        (this.handleEl = (e) => {
    ...
    needsXScrolling() {
      if (Ps.test(this.props.overflowX)) return !1;
      let { el: e } = this,
    ...
    needsYScrolling() {
      if (Ps.test(this.props.overflowY)) return !1;
      let { el: e } = this,
    ...
    getXScrollbarWidth() {
      return Ps.test(this.props.overflowX)
        ? 0
        : this.el.offsetHeight - this.el.clientHeight;
    }
    getYScrollbarWidth() {
      return Ps.test(this.props.overflowY)
        ? 0
  ...
  function Us(e, t) {
    return null != t.maxHeight || zs(e, t);
  }
  function Ws(e, t, n, r) {
    let { expandRows: i } = n;
    ...
    for (let r of e) {
      ...
      for (let i = 0; i < e; i += 1)
        n.push(
          f("col", {
            style: {
              width: "shrink" === r.width ? Vs(t) : r.width || "",
              minWidth: r.minWidth || "",
            },
          })
        );
  ...
  class $s extends Un {
    constructor() {
      super(...arguments),
        (this.processCols = Ut((e) => e, Ls)),
        (this.renderMicroColGroup = Ut(Fs)),
        (this.scrollerRefs = new Bs()),
        (this.scrollerElRefs = new Bs(this._handleScrollerEl.bind(this))),
        (this.state = {
          shrinkWidth: null,
          forceYScrollbars: !1,
      ...
      return "outerContent" in e
        ...
        : f(
            "tr",
            {
              key: e.key,
              role: "presentation",
              className: qs(e, this.props.liquid).join(" "),
            },
    ...
    computeShrinkWidth() {
      return Gs(this.props.cols) ? js(this.scrollerElRefs.getAll()) : 0;
    }
    computeScrollerDims() {
      let e = Vi(),
  ...
  $s.addStateEquality({ scrollerClientWidths: En, scrollerClientHeights: En });
  class Js extends Un {
    constructor() {
      super(...arguments),
        (this.handleEl = (e) => {
    ...
    render() {
      const { props: e, context: t } = this,
        ...
        { ui: s } = i,
        o = {
          event: new Yr(t, i.def, i.instance),
          view: t.viewApi,
          timeText: e.timeText,
          textColor: s.textColor,
          backgroundColor: s.backgroundColor,
          borderColor: s.borderColor,
          isDraggable: !e.disableDragging && si(r, t),
          isStartResizable: !e.disableResizing && oi(r, t),
          isEndResizable: !e.disableResizing && ai(r),
  ...
  class ro extends Un {
    constructor() {
      super(...arguments), (this.refineRenderProps = Wt(so));
    }
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
      ...
      return f(
        Qn,
        Object.assign({}, e, {
          elClasses: [...Bi(r, t.theme), ...(e.elClasses || [])],
          elAttrs: Object.assign(
  ...
  function so(e) {
    let { date: t, dateEnv: n, dateProfile: r, isMonthStart: i } = e,
      ...
      o = e.showDayNumber ? n.format(t, i ? e.monthStartFormat : no) : "";
    return Object.assign(
    ...
    updateSize() {
      let { isRtl: e } = this.context,
        ...
        i = (function (e) {
          ...
          for (let e of t) {
            let t = Ti(n, e.getBoundingClientRect());
            if (!t) return null;
            n = t;
          }
          return n;
          ...
          Boolean(e.moreCnt) &&
            f(
              Qn,
              {
                ...
                defaultGenerator: e.defaultGenerator || po,
  ...
  function mo(e) {
    ...
    let { hiddenSegs: t } = e;
    return { start: vo(t), end: ((n = t), n.reduce(bo).eventRange.range.end) };
    var n;
  }
  function vo(e) {
    return e.reduce(yo).eventRange.range.start;
  }
  function yo(e, t) {
  ...
  var Eo = {
      ...
      DelayedRunner: Re,
      ElementDragging: cs,
      ElementScrollController: Ki,
      Emitter: jr,
      EventContainer: Js,
      EventImpl: Yr,
      Interaction: wi,
      MoreLinkContainer: go,
      NamedTimeZoneImpl: class {
        constructor(e) {
          this.timeZoneName = e;
        }
      },
      NowIndicatorContainer: to,
      NowTimer: bs,
      PositionCache: Xi,
      RefMap: Bs,
      ScrollController: Ji,
      ...
      ViewContainer: Yn,
      ViewContextType: Bn,
      WeekNumberContainer: co,
      WindowScrollController: es,
      addDays: bt,
      addDurations: dt,
      addMs: Et,
      addWeeks: yt,
      ...
      buildEntryKey: is,
      buildEventApis: Xr,
      buildEventRangeKey: ui,
      buildIsoString: Pt,
      buildNavLinkAttrs: Ui,
      buildSegTimeText: li,
      collectFromHash: Cn,
      combineEventUis: Tr,
      ...
      compareNumbers: rt,
      compareObjs: Dn,
      computeEarliestSegStart: vo,
      computeEdges: Qi,
      computeFallbackHeaderFormat: fs,
      computeInnerRect: qi,
      computeRect: Yi,
      computeShrinkWidth: js,
      computeVisibleDayRange: ir,
      config: ds,
      constrainPoint: ki,
      createDuration: lt,
      createEmptyEventStore: Ar,
      createEventInstance: cr,
      createEventUi: _r,
      createFormatter: tn,
      diffDates: or,
      diffDayAndTime: Dt,
      ...
      getCanVGrowWithinCell: Ai,
      getClippingParents: Zi,
      getDateMeta: Hi,
      getDayClassNames: Bi,
      getDefaultEventEnd: Fr,
      getElSeg: ei,
      getEntrySpanEnd: rs,
      getEventTargetViaRoot: Ne,
      getIsRtlScrollbarOnLeft: Fi,
      getRectCenter: Mi,
      getRelevantEvents: Sr,
      getScrollGridClassNames: Qs,
      getScrollbarWidths: Vi,
      getSectionClassNames: qs,
      getSectionHasLiquidHeight: zs,
      getSegAnchorAttrs: hi,
      getSegMeta: ci,
      ...
      getStickyFooterScrollbar: Xs,
      getStickyHeaderDates: Zs,
      getUniqueDomId: He,
      greatestDurationDenominator: pt,
      groupIntersectingEntries: ss,
      guid: Ve,
      hasBgRendering: Jr,
      hasCustomDayCellContent: io,
      hasShrinkWidth: Gs,
      identity: fn,
      injectStyles: De,
      interactionSettingsStore: Ri,
      interactionSettingsToStore: Ci,
      intersectRanges: Jn,
      intersectRects: Ti,
      intersectSpans: os,
      isArraysEqual: mt,
      isColPropsEqual: Ls,
      isDateSelectionValid: _s,
      isDateSpansEqual: pi,
      isInt: it,
      isInteractionValid: xs,
      isMultiDayRange: sr,
      isPropsEqual: En,
      isPropsValid: ks,
      isValidDate: Ot,
      ...
      preventDefault: Be,
      preventSelection: qe,
      rangeContainsMarker: nr,
      rangeContainsRange: tr,
      rangesEqual: Kn,
      rangesIntersect: er,
      refineEventDef: mr,
      refineProps: hn,
      ...
      renderChunkContent: Ws,
      renderFill: lo,
      renderMicroColGroup: Fs,
      renderScrollShim: Ys,
      requestJson: Ei,
      sanitizeShrinkWidth: Vs,
      setRef: Wn,
      sliceEventStore: $r,
      sortEventSegs: ri,
      startOfDay: Rt,
  ...
  const Ao = [],
    ...
    wo = Object.assign(Object.assign({}, Do), {
      buttonHints: {
        prev: "Previous $0",
        next: "Next $0",
  ...
  function Po(e, t, n, r) {
    ...
    return vn(
      (function (e, t) {
        let n,
          r = {};
        for (n in e) Io(n, r, e, t);
        for (n in t) Io(n, r, e, t);
        return r;
      })(i, s),
      (e) =>
        (function (e, t, n, r, i) {
  ...
  (Mo.prototype.classes = {
    ...
    (Mo.prototype.baseIconClass = "fc-icon"),
    (Mo.prototype.iconClasses = {
      close: "fc-icon-x",
    ...
    (Mo.prototype.rtlIconClasses = {
      prev: "fc-icon-chevron-right",
      next: "fc-icon-chevron-left",
      prevYear: "fc-icon-chevrons-right",
      nextYear: "fc-icon-chevrons-left",
    }),
    (Mo.prototype.iconOverrideOption = "buttonIcons"),
    (Mo.prototype.iconOverrideCustomButtonOption = "icon"),
    (Mo.prototype.iconOverridePrefix = "fc-icon-");
  let Ho = {};
  function Bo(e, t, n) {
  ...
  function jo(e, t, n, r) {
    ...
    switch (t.type) {
      ...
      case "FETCH_EVENT_SOURCES":
        return Lo(
          e,
          t.sourceIds ? yn(t.sourceIds) : Vo(e, r),
          i,
          t.isRefetch || !1,
          r
        );
  ...
  function Wo(e, t, n) {
    return Lo(
      ...
      mn(e, (e) =>
        (function (e, t, n) {
          if (!Go(e, n)) return !e.latestFetchId;
          return (
  ...
  function Xo(e, t, n, r, i) {
    return {
      header: e.headerToolbar ? $o(e.headerToolbar, e, t, n, r, i) : null,
      footer: e.footerToolbar ? $o(e.footerToolbar, e, t, n, r, i) : null,
    };
  }
  ...
  const ta = [
      ...
      eventSourceDefs: [
        {
          ...
          fetch(e, t, n) {
            ...
            yi(
              e.eventSource.meta.bind(null, mi(e.range, r)),
              (e) => t({ rawEvents: e }),
              n
            );
          },
      ...
      recurringTypes: [
        {
          ...
          expand(e, t, n) {
            let r = Jn(t, { start: e.startRecur, end: e.endRecur });
            return r
              ? (function (e, t, n, r) {
                  let i = e ? yn(e) : null,
                    s = Rt(n.start),
    ...
    _o({
      name: "misc",
      isLoadingFuncs: [(e) => zo(e.eventSources)],
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            "datesSet",
            Object.assign(Object.assign({}, mi(e.activeRange, t.dateEnv)), {
              view: t.viewApi,
            })
          );
        },
  ...
  class ia {
    constructor(e) {
      (this.computeCurrentViewData = Ut(this._computeCurrentViewData)),
        (this.organizeRawLocales = Ut(Co)),
        (this.buildLocale = Ut(Ro)),
        (this.buildPluginHooks = To()),
        (this.buildDateEnv = Ut(sa)),
        (this.buildTheme = Ut(oa)),
        (this.parseToolbars = Ut(Xo)),
        (this.buildViewSpecs = Ut(Po)),
        (this.buildDateProfileGenerator = Wt(aa)),
        (this.buildViewApi = Ut(la)),
        (this.buildViewUiProps = Wt(ua)),
        (this.buildEventUiBySource = Ut(ca, En)),
        (this.buildEventUiBases = Ut(da)),
        (this.parseContextBusinessHours = Wt(fa)),
        (this.buildTitle = Ut(ra)),
        (this.emitter = new jr()),
        (this.actionRunner = new na(
      ...
      nr(o.activeRange, s) || (s = o.currentRange.start);
      let a = {
        dateEnv: n.dateEnv,
      ...
      let l = Bo(n.calendarOptions, o, a),
        c = {
      ...
      ha(c, a) && this.emitter.trigger("loading", !0),
        (this.state = c),
        this.updateData(),
    ...
    _handleAction(e) {
      ...
      this.data &&
        ...
        ("PREV" !== e.type && "NEXT" !== e.type && nr(d.currentRange, c)) ||
          (c = d.currentRange.start);
      let u = jo(n.eventSources, e, d, l),
        h = Nr(n.eventStore, e, u, d, l),
        f =
          (zo(u) &&
    ...
    processRawCalendarOptions(e, t) {
      let { locales: n, locale: r } = un([rn, e, t]),
        ...
        a = this.buildPluginHooks(e.plugins || [], ta),
  ...
  function sa(e, t, n, r, i, s, o, a) {
    let l = Ro(t || o.defaultCode, o.map);
    return new Mn({
  ...
  function oa(e, t) {
    return new (t.themeClasses[e.themeSystem] || Mo)(e);
  }
  function aa(e) {
  ...
  function fa(e) {
    return Ur(e.options.businessHours, e);
  }
  function ga(e, t) {
    for (let n in e)
        ...
        (this.handleSegClick = (e, t) => {
          ...
          if (i && n.isValidSegDownEl(e.target)) {
            ...
            r.emitter.trigger("eventClick", {
              el: t,
              event: new Yr(n.context, i.eventRange.def, i.eventRange.instance),
              jsEvent: e,
              view: r.viewApi,
            }),
  ...
  class ba extends wi {
    ...
    triggerEvent(e, t, n) {
      ...
      (t && !r.isValidSegDownEl(t.target)) ||
        i.emitter.trigger(e, {
          el: n,
          event: new Yr(i, s.eventRange.def, s.eventRange.instance),
          jsEvent: t,
          view: i.viewApi,
        });
    }
  ...
  class Ea extends zn {
    constructor() {
      super(...arguments),
        ...
        (this.buildViewPropTransformers = Ut(Aa)),
        (this.buildToolbarProps = Ut(Sa)),
        ...
        (this.registerInteractiveComponent = (e, t) => {
          let n = (function (e, t) {
            ...
            r = [ya, ba]
              ...
              .map((e) => new e(n));
          (this.interactionsStore[e.uid] = r), (Ri[e.uid] = n);
        }),
  ...
  function Sa(e, t, n, r, i, s) {
    ...
    return {
      ...
      isTodayEnabled: o.isValid && !nr(t.currentRange, i),
  ...
  class xa {
    constructor(e) {
      (this.subjectEl = null),
        ...
        (Ca += 1),
        1 === Ca && window.addEventListener("touchmove", _a, { passive: !1 });
    }
    destroy() {
      this.containerEl.removeEventListener("mousedown", this.handleMouseDown),
        ...
        (Ca -= 1),
        Ca || window.removeEventListener("touchmove", _a, { passive: !1 });
    }
    tryStart(e) {
    ...
    handleMove(e, t) {
      if (this.isEnabled) {
        ...
        i < 0 ? (this.everMovedUp = !0) : i > 0 && (this.everMovedDown = !0),
          ...
          this.isAnimating ||
            ((this.isAnimating = !0), this.requestAnimation(Oa()));
      }
    }
    stop() {
      if (this.isEnabled) {
  ...
  class Ha {
    constructor(e) {
      (this.origRect = Yi(e)),
        (this.scrollCaches = Zi(e).map((e) => new Ma(e, !0)));
    }
    destroy() {
      for (let e of this.scrollCaches) e.destroy();
    }
    ...
    isWithinClipping(e, t) {
      ...
      for (let e of this.scrollCaches)
        if (!Ba(e.getEventTarget()) && !_i(n, e.clientRect)) return !1;
      return !0;
    }
  }
  function Ba(e) {
  ...
  class ja {
    ...
    processFirstCoord(e) {
      let t,
        ...
        r = n,
        i = e.subjectEl;
      i instanceof HTMLElement && ((t = Yi(i)), (r = ki(r, t)));
      ...
      for (let s in n) {
        ...
        if (a && a.isWithinClipping(e, t)) {
          ...
          if (l >= 0 && l < u && c >= 0 && c < h) {
            ...
            e &&
              tr(e.dateProfile.activeRange, e.dateSpan.range) &&
              (!i || e.layer > i.layer) &&
              ((e.componentId = s),
              (e.context = o.context),
              (e.rect.left += n),
  ...
  function za(e, t) {
    return (
      (!e && !t) || (Boolean(e) === Boolean(t) && pi(e.dateSpan, t.dateSpan))
    );
  }
  function Ua(e, t) {
    let n = {};
    ...
    constructor(e) {
      super(e),
        ...
        (this.handlePointerDown = (e) => {
          ...
          let a = (this.subjectSeg = ei(e.subjectEl)),
            l = (this.eventRange = a.eventRange).instance.instanceId;
          (this.relevantEvents = Sr(o.getCurrentData().eventStore, l)),
          ...
          e.isTouch
            ...
            this.isDragging &&
              ...
              t.emitter.trigger("eventDragStart", {
                el: this.subjectEl,
                event: new Yr(t, n.def, n.instance),
                jsEvent: e.origEvent,
                view: t.viewApi,
              }));
        }),
          ...
          if (e) {
            ...
            i === s || (t.editable && t.droppable)
              ? ((o = (function (e, t, n) {
                ...
                o &&
                  ((a = Vr(n, s.getCurrentData().eventUiBases, o, s)),
                  (c.mutatedEvents = a),
                  xs(c, e.dateProfile, s) ||
                    ((l = !0),
                    (o = null),
                    (a = null),
      ...
      (r.pointer.selector = Wa.SELECTOR),
        (r.touchScrollAllowed = !1),
        (r.autoScroller.isEnabled = n.dragScroll);
      let i = (this.hitDragging = new ja(this.dragging, Ri));
  ...
  Wa.SELECTOR = ".fc-event-draggable, .fc-event-resizable";
  const La = { fixedMirrorParent: fn },
    Fa = {
      dateClick: fn,
      eventDragStart: fn,
      eventDragStop: fn,
  ...
  class Va {
    constructor(e, t) {
            ...
            this.canDropElOnCalendar(n.subjectEl, i) &&
              ((s = (function (e, t, n) {
                ...
                let l = t.duration
                    ...
                    : Fr(e.allDay, a, n),
                  c = cr(o.defId, { start: a, end: l });
                return { def: o, instance: c };
              })(e.dateSpan, this.dragMeta, i)),
              (a.mutatedEvents = Er(s)),
              (o = !xs(a, e.dateProfile, i)),
              o &&
        ...
        (this.handleDragEnd = (e) => {
          ...
          if ((this.clearDrag(), t && n)) {
            ...
            if (
              (t.emitter.trigger(
                "drop",
                Object.assign(Object.assign({}, Ua(r.dateSpan, t)), {
                  draggedEl: e.subjectEl,
                  jsEvent: e.origEvent,
                  view: i,
                })
      ...
      let n = (this.hitDragging = new ja(e, Ri));
      (n.requireInitial = !1),
    ...
    buildDragMeta(e) {
      return "object" == typeof this.suppliedDragMeta
        ? hs(this.suppliedDragMeta)
        : "function" == typeof this.suppliedDragMeta
        ? hs(this.suppliedDragMeta(e))
        : (function (e) {
            let t = (function (e, t) {
            ...
            return hs(t ? JSON.parse(t) : { create: !1 });
          })(e);
    }
    displayDrag(e, t) {
    ...
    componentInteractions: [
      class extends wi {
        constructor(e) {
          ...
          let t = (this.hitDragging = new ja(this.dragging, Ci(e)));
          t.emitter.on("pointerdown", this.handlePointerDown),
      ...
      class extends wi {
        constructor(e) {
            ...
            (this.handleHitUpdate = (e, t) => {
              ...
              if (e) {
                ...
                (e.componentId === t.componentId &&
                  ...
                  (r && _s(r, e.dateProfile, n)) || ((i = !0), (r = null));
              }
              r
          ...
          (r.touchScrollAllowed = !1),
            ...
            (r.autoScroller.isEnabled = n.dragScroll);
          let i = (this.hitDragging = new ja(this.dragging, Ci(e)));
          i.emitter.on("pointerdown", this.handlePointerDown),
            i.emitter.on("dragstart", this.handleDragStart),
            i.emitter.on("hitupdate", this.handleHitUpdate),
            i.emitter.on("pointerup", this.handlePointerUp);
        ...
        constructor(e) {
          super(e),
            ...
            (this.handleHitUpdate = (e, t, n) => {
              ...
              a &&
                ((l = Vr(i, r.getCurrentData().eventUiBases, a, r)),
                (d.mutatedEvents = l),
                xs(d, e.dateProfile, r) ||
          ...
          let r = (this.hitDragging = new ja(this.dragging, Ci(e)));
    ...
    calendarInteractions: [
      class {
        constructor(e) {
          (this.context = e),
            ...
            (this.onDocumentPointerDown = (e) => {
              ...
              (this.matchesCancel = !!_e(n, t)),
                (this.matchesEvent = !!_e(n, Wa.SELECTOR));
            }),
          ...
          let t = (this.documentPointer = new xa(document));
  ...
  class qa extends ts {
    ...
    renderHScrollLayout(e, t, n, r) {
      ...
      let { props: s, context: o } = this,
        a = !s.forPrint && Zs(o.options),
        l = !s.forPrint && Xs(o.options),
        c = [];
      return (
        e &&
          c.push({
  ...
  class el extends Un {
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
        { seg: r } = e,
        i = li(r, n.eventTimeFormat || $a, t, !0, e.defaultDisplayEventEnd);
      return f(
        Js,
        Object.assign({}, e, {
          elTag: "a",
  ...
  class sl extends ts {
    ...
    render() {
      let { context: e, props: t, state: n, rootElRef: r } = this,
        ...
        a =
          t.showDayNumber &&
          "month" !== o.currentRangeUnit &&
          (o.currentRange.start.valueOf() === s.valueOf() ||
            1 === s.getUTCDate());
      return f(
        ro,
        {
        ...
        (o, l) =>
          f(
            ...
            !l.isDisabled && (t.showDayNumber || io(i) || t.forceDayTop)
              ? f(
                  "div",
                  ...
                  f(o, {
                    ...
                    elClasses: [
                      ...
                      a && "fc-daygrid-month-start",
                    ],
                    elAttrs: Object.assign(Object.assign({}, Ui(e, s)), {
                      id: n.dayNumberId,
                    }),
                  })
                )
  ...
  function ll(e, t, n, r) {
    ...
    let i = e.eventRange,
      s = i.range,
      o = Jn(s, { start: r[t].date, end: bt(r[n - 1].date, 1) });
    return Object.assign(Object.assign({}, e), {
      firstCol: t,
      lastCol: n - 1,
      eventRange: {
        ...
        if (!i[e])
          if (this.allowReslicing) {
            const e = Object.assign(Object.assign({}, s), {
              span: os(s.span, t.span),
            });
            (i[is(e)] = !0), (r[o][a] = e), this.splitEntry(s, t, n);
          } else (i[e] = !0), n.push(s);
      }
  ...
  class dl extends ts {
    constructor() {
      super(...arguments),
        (this.cellElRefs = new Bs()),
        (this.frameElRefs = new Bs()),
        (this.fgElRefs = new Bs()),
        (this.segHarnessRefs = new Bs()),
        (this.rootElRef = { current: null }),
        (this.state = {
          framePositions: null,
        ...
        for (let o of e) {
          ...
          s.push(
            f(
              ...
              "bg-event" === t
                ? f(oo, Object.assign({ seg: o }, ci(o, r)))
                : lo(t)
            )
          );
        }
        ...
        if (e) {
          ...
          if (e.length) {
            ...
            (n.framePositions && n.framePositions.similarTo(r)) ||
              this.setState({ framePositions: new Xi(t, e, !0, !1) });
          }
        }
  ...
  class ul extends ts {
    ...
    prepareHits() {
      (this.rowPositions = new Xi(
        this.rootEl,
        this.rowRefs.collect().map((e) => e.getCellEls()[0]),
        !1,
        !0
      )),
        (this.colPositions = new Xi(
          this.rootEl,
  ...
  class El extends Ni {
    ...
    getKeysForEventDef(e) {
      return e.allDay ? (Jr(e) ? ["timed", "allDay"] : ["allDay"]) : ["timed"];
    }
  }
  const Sl = tn({
    hour: "numeric",
  ...
  class Rl extends ts {
      ...
      super(...arguments),
        ...
        (this.renderHeadAxis = (e, t = "") => {
          let { options: n } = this.context,
            ...
            i = r.renderRange,
            s =
              1 === At(i.start, i.end) ? Ui(this.context, i.start, "week") : {};
    ...
    renderHScrollLayout(e, t, n, r, i, s, o) {
      ...
      let { context: l, props: c } = this,
        d = !c.forPrint && Zs(l.options),
        u = !c.forPrint && Xs(l.options),
        h = [];
      e &&
        h.push({
          type: "header",
              ...
              content: (e) =>
                f(
                  ...
                  f(
                    ...
                    e.tableColGroupNode,
                    f("tbody", null, f(wl, { slatMetas: s }))
                  ),
                  f(
                    "div",
                    { className: "fc-timegrid-now-indicator-container" },
                    f(bs, { unit: g ? "minute" : "day" }, (e) => {
    ...
    render() {
      ...
      return f(
        go,
        {
          ...
          dateProfile: e.dateProfile,
          todayRange: e.todayRange,
          popoverContent: () => Vl(e.hiddenSegs, e),
          defaultGenerator: Nl,
        },
        (e) =>
          f(e, {
  ...
  function Hl(e, t) {
    ...
    return o.sort(Bl), [o.map(jl), o[0][1]];
  }
  function Bl(e, t) {
    return t[1] - e[1];
  }
  ...
  const Wl = tn({ hour: "numeric", minute: "2-digit", meridiem: !1 });
  class Ll extends Un {
    render() {
      return f(
        Ks,
  ...
  class Fl extends Un {
    constructor() {
      super(...arguments), (this.sortEventSegs = Ut(ri));
    }
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
      ...
      return f(
        ...
        (t) =>
          f(
            ...
            io(n) && f(t, { elTag: "div", elClasses: ["fc-timegrid-col-misc"] })
          )
      );
    }
    renderFgSegs(e, t, n, r, i) {
      let { props: s } = this;
      return s.forPrint ? Vl(e, s) : this.renderPositionedFgSegs(e, t, n, r, i);
    }
    ...
    renderFillSegs(e, t) {
      let { props: n, context: r } = this,
        i = Ul(e, n.date, n.slatCoords, r.options.eventMinHeight).map(
          (r, i) => {
            let s = e[i];
            return f(
              "div",
              ...
              "bg-event" === t
                ? f(
                    oo,
                    Object.assign({ seg: s }, ci(s, n.todayRange, n.nowDate))
                  )
                : lo(t)
            );
          }
  ...
  class Ql extends Un {
    constructor() {
      super(...arguments),
        (this.splitFgEventSegs = Ut(Ml)),
        (this.splitBgEventSegs = Ut(Ml)),
        (this.splitBusinessHourSegs = Ut(Ml)),
        (this.splitNowIndicatorSegs = Ut(Ml)),
        (this.splitDateSelectionSegs = Ut(Ml)),
        (this.splitEventDrag = Ut(Il)),
        (this.splitEventResize = Ut(Il)),
        (this.rootElRef = { current: null }),
        (this.cellElRefs = new Bs());
    }
    render() {
  ...
  class Xl extends ts {
    ...
    render() {
      ...
      return f(bs, { unit: i ? "minute" : "day" }, (a, l) =>
        f(
          ql,
          Object.assign(
      ...
      l =
        ...
        (function (e) {
          ...
          for (t = Jl.length - 1; t >= 0; t -= 1)
            if (((n = lt(Jl[t])), (r = gt(n, e)), null !== r && r > 1))
              return n;
          return e;
        })(r),
      c = [];
  ...
  var nc = _o({
    ...
    views: {
      timeGrid: {
        component: class extends Rl {
          constructor() {
            super(...arguments),
              (this.buildTimeColsModel = Ut(ec)),
              (this.buildSlatMetas = Ut(Kl));
          }
          render() {
            let {
                options: e,
        ...
        u = Object.assign(
          {
            ...
            text: c,
            sideText: d,
            navLinkAttrs: Ui(this.context, s),
            sideNavLinkAttrs: Ui(this.context, s, "day", !1),
          },
          l
        );
      return f(
  ...
  const sc = tn({ hour: "numeric", minute: "2-digit", meridiem: "short" });
  class oc extends Un {
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
        { seg: r, timeHeaderId: i, eventHeaderId: s, dateHeaderId: o } = e,
        a = n.eventTimeFormat || sc;
      return f(
        Js,
        Object.assign({}, e, {
          elTag: "tr",
            ...
            (function (e, t, n, r, i) {
              ...
              if (!1 !== s.displayEventTime) {
                ...
                if (
                  (a.allDay
                    ? (c = !0)
                    : sr(e.eventRange.range)
                    ? e.isStart
                      ? (o = li(e, t, n, null, null, l.range.start, e.end))
                      : e.isEnd
                      ? (o = li(e, t, n, null, null, e.start, l.range.end))
                      : (c = !0)
                    : (o = li(e, t, n)),
                  c)
                ) {
              ...
              for (let n = 0; n < a.length; n += 1) {
                ...
                if (d) {
                  let a = Ht(t[n]),
                    u = o + "-" + a;
                  c.push(
                    f(rc, { key: a, cellId: u, dayDate: t[n], todayRange: l })
                  ),
                    (d = ri(d, r.eventOrder));
                  for (let t of d)
                    c.push(
  ...
  function pc(e, t, n, r, i) {
    ...
    for (; a.valueOf() < o.valueOf(); ) {
      ...
      const d = t.activeRange ? Jn(t.activeRange, i ? c : o) : null;
      l.push({
  ...
  const mc = tn({ year: "numeric", month: "long" }),
    vc = tn({ month: "long" });
  function yc(e, t) {
    return (
      e ||
    ...
    views: {
      multiMonth: {
        component: class extends ts {
          constructor() {
            super(...arguments),
              (this.splitDateProfileByMonth = Ut(pc)),
              (this.buildMonthFormat = Ut(yc)),
  ...
  return (
    ta.push(Qa, bl, nc, hc, Ec),
    (e.Calendar = class extends xi {
      constructor(e, t = {}) {
        super(),
          (this.isRendering = !1),
          (this.isRendered = !1),
